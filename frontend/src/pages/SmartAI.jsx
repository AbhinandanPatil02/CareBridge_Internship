...
//         const prompt = `Extract and summarize this medical report in ${reportLanguage} (simple terms). Include:
//         1. Key findings
//         2. Abnormal values
//         3. Recommended actions
//         Keep it concise (150-200 words).
...
//         setReportSummary(apiResponse.data?.candidates?.[0]?.content?.parts?.[0]?.text || 'No summary available');
//         setFile(null);
//         setFilePreview(null);
//       };
//     } catch (err) {
...
//                 disabled={!file || isProcessingReport}
//               >
//                 {isProcessingReport ? 'Generating Summary...' : 'Analyze Report'}
//               </button>
//             </form>
